        ...
        <div <?php $this->parent->print_render_attribute_string('hover_video_attr'); ?>>
            ...
            <div class="bdt-hover-wrapper-list">
                <div <?php $this->parent->print_render_attribute_string('hover_video_list'); ?>>
                    ...
                    ?>
                        <video <?php $this->parent->print_render_attribute_string('bdt_hover_video_attr'); ?> oncontextmenu="return false;" src="<?php echo esc_url($video_source); ?>" poster="<?php echo esc_url($video_poster); ?>" muted>
                        </video>
                    <?php endforeach; ?>
                </div>
